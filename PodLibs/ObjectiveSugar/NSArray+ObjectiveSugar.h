...
/**
 Separate the array to subArrarys, each of the subarray has subArrayCount of elements,
 if the last one does not have enoungh number,it will has all the rest.
 
 @param Number of elements to divide the array
 @return An array of elements
 */
-(NSArray*)divide:(NSUInteger)subArrayCount;
